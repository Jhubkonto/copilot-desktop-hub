...
function copyWorkers() {
  return {
    ...
    closeBundle() {
      ...
      copyFileSync(
        resolve(__electron_vite_injected_dirname, "src/main/user-input-mcp-worker.cjs"),
        resolve(outDir, "user-input-mcp-worker.cjs")
      );
      copyFileSync(
        resolve(__electron_vite_injected_dirname, "src/main/project-wiki-mcp-worker.cjs"),
        resolve(outDir, "project-wiki-mcp-worker.cjs")
      );
      copyFileSync(
        resolve(__electron_vite_injected_dirname, "src/main/skill-save-mcp-worker.cjs"),
