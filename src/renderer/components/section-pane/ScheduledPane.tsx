...
import { Plus, Play, Pause, Pencil, Trash2, RefreshCw, Clock, CheckCircle2, XCircle, AlertTriangle, Loader2 } from 'lucide-react'
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-2 border-t border-gray-100 dark:border-gray-800">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white text-xs font-medium transition-colors"
        >
