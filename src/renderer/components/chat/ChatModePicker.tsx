...
interface Props {
  ...
  onChange: (mode: { thinkingEffortOverride?: ThinkingEffort | null; fullAutoApproveOverride?: boolean | null }) => void
}
...
export function ChatModePicker({ open, onOpenChange, thinkingEffortOverride, fullAutoApproveOverride, onChange }: Props) {
  const hasOverride = thinkingEffortOverride !== null || fullAutoApproveOverride !== null
  return (
    <DropdownPanel
      open={open}
