...
import { CheckCircle, ChevronDown, ChevronRight, Loader2, Package, Sparkles, Copy, Settings, Trash2 } from 'lucide-react'
import type { ArtifactRow, ArtifactVersion } from '@shared/types'
import { useAppStore } from '../../store/app-store'
import { Button, ModalShell, TextField } from '../ui/primitives'
...
function ArtifactRowItem({ artifact, onRevise, onUseInChat, onDeleted }: {
    ...
    <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
      ...
      {confirmingDelete && (
        <ModalShell
          ...
          footer={
            <>
              <Button ref={cancelDeleteRef} onClick={() => setConfirmingDelete(false)} className="px-4 py-2 text-sm">
                Cancel
              </Button>
              <Button
                variant="primary"
        ...
        >
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">
            The database record will be removed. Files on disk will stay.
          </p>
