...
export function createMockAppStore(overrides: Record<string, unknown> = {}) {
  return {
    ...
    pendingNewRequestDraft: null as import('../../renderer/store/slices/uiSlice').PendingNewRequestDraft | null,
    pendingCodeChangesProjectId: null as string | null,
