...
export function createMockApi() {
  return {
    ...
    manualWorkflowGeneratorChat: vi.fn().mockResolvedValue({ started: true }),
    onManualWorkflowGeneratorToken: vi.fn().mockReturnValue(() => {}),
    onManualWorkflowGeneratorSpecReady: vi.fn().mockReturnValue(() => {}),
