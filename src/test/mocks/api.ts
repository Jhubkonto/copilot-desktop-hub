...
export function createMockApi() {
  return {
    ...
    listManagedWorkflowSources: vi.fn().mockResolvedValue([]),
    getManagedWorkflowVersion: vi.fn().mockResolvedValue(null),
    getManagedWorkflowBindings: vi.fn().mockResolvedValue([]),
    editManagedWorkflowVersion: vi.fn().mockResolvedValue(null),
    reviewManagedWorkflowVersion: vi.fn().mockResolvedValue(null),
    regenerateManagedWorkflowSteps: vi.fn().mockResolvedValue(null),
    createManagedWorkflowPublishPreview: vi.fn().mockResolvedValue(null),
    confirmManagedWorkflowPublish: vi.fn().mockResolvedValue(null),
    ...
    schedulerResumeRun: vi.fn().mockResolvedValue(null),
    ...
    generateDebriefStory: vi.fn().mockResolvedValue({
      story: { title: 'Test Story', beats: [{ caption: 'A problem appeared.', mood: 'problem', svg: '<svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="20" fill="currentColor"/></svg>' }] },
      artifactId: 'debrief-artifact-1',
      versionId: 'debrief-version-1',
    }),
